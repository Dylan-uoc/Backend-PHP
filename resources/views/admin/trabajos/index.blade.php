                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <b>Lista Trabajos de la clase: {{ $clase->name }}</b>
                                <span class="">
                                    ...
                                    <tbody>
                                        @foreach ($trabajos as $trabajo)
                                            <tr>
                                                ...
                                                <td class="">
                                                    <p><b>{{ App\Models\Estudiante::find($trabajo->id_student)->name }} {{ App\Models\Estudiante::find($trabajo->id_student)->surname }}</b></p>
                                                </td>
                                                <td class="">
                                                    <p><b>{{ $trabajo->name }}</b>
                                                    </p>
                                                ...
                                                <td class="">
                                                    <p><b>{{ date("d/m/Y", strtotime($trabajo->fecha)) }}</b>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <a class="btn btn-sm btn-outline-primary"
                                                        href="/admin/clases/editar/{{ $trabajo->id }}">Editar</a>
                                                    <button class="btn btn-sm btn-outline-danger eliminar_clase"
                                                        type="button" data-id="{{ $trabajo->id }}">Borrar</button>                                                   
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
